"""
Figure 4.2, Panel B — Functional annotation of putative acetyltransferases.
...
Outputs:
    plots_dir/figure4_2-panelB.png / .pdf
    plots_dir/legends/figure4_2-panelB-legend.png / .pdf
"""
...
def plot_figure4_2_panelB(
    ...
    """
    Produce Figure 4.2 Panel B: functional annotation of putative acetyltransferases.
    ...
    for ext in ("png", "pdf"):
        out = plots_dir / f"figure4_2-panelB.{ext}"
        fig.savefig(out, dpi=dpi, bbox_inches="tight")
        print(f"  [figure4_2-panelB] → {out.name}")
    plt.close(fig)
    ...
    plt.tight_layout()
    for ext in ("png", "pdf"):
        out = legends_dir / f"figure4_2-panelB-legend.{ext}"
        fig_leg.savefig(out, dpi=dpi, bbox_inches="tight")
        print(f"  [figure4_2-panelB-legend] → legends/{out.name}")
    plt.close(fig_leg)
